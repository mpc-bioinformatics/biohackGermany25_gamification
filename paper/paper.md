...
One popular de.NBI training course of the BioInfra.prot service center (Bioinformatics for proteomics)  [@citesAsRelated:turewicz_bioinfraprot_2017] is the introductory R course   [“Differential analysis of proteomics data using R”](https://www.denbi.de/online-training-media-library/1172-differential-analysis-of-quantitative-proteomics-data-using-r ). This course is aimed at life scientists starting with [R](https://www.R-project.org/ ), so no preliminary knowledge about programming is required. In the course of this biohackathon project we searched for options to provide interactive tutorials for R, that can be used as online training material for self learning. The main idea is that the learners can independently practice and get direct feedback if their used commands or code is correct. 
